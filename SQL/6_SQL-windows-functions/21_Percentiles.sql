...
has made to encourage them to order more similarly sized large orders.
...
/* 2) Use the NTILE functionality to divide the accounts into two levels in
terms of the amount of gloss_qty for their orders. Your resulting table should
 have the account_id, the occurred_at time for each order, the total amount of
...
Your resulting table should have the account_id, the occurred_at time for each
